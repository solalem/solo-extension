...
export const replacePlaceholders = function (path: string, model: Model, context: FeatureDesign, callback: any) {
  ...
  let pathProper = template({ context: context, model: model });
